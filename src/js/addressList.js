                    ...
                    return (
                        ...
                        (n.id = t),
                        {
                            ...
                            newDomEmail: (function (e, t) {
                                ...
                                return (i.innerHTML = "<p style='color: white; font-size: 0.8em;'>&#10006;</p>"), (i.addEventListener("click",() => {
                                    n.remove()
                                    last_exception_tick = tick()
                                })), i.classList.add("emailsEditor__delete-button"), (i.dataset.deleteIdentifierEmailId = t), n.appendChild(i), n;
                            })(n, t),
                        }
                    );
                };
